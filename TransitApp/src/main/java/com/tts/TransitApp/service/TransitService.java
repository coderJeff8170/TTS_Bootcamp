...
public class TransitService {
	...
	private List<Bus> getBuses(){
		...
		//this sends out a request to the transit url for bus data 
...
//		    List<Bus> buses = Arrays.asList(mapper.readValue(Paths.get("marta-some.json").toFile(), Bus[].class));
//
...
//		
	...
	//make a method that returns a person location and call it in the controller
