...
An array called photoList that contains the names of the photos as strings[X]

An integer currentPhotoIndex that represents which photo in the photoList is currently displayed[X]

A nextPhoto() function that moves currentPhotoIndex to the next index ifthere is one, and:

logs the current photo name.[X]

Otherwise, log "End of slideshow";[X]

A prevPhoto() function that does the same thing, but backwards.[X]

A function getCurrentPhoto() that returns the current photo from the list.[X]
*/
