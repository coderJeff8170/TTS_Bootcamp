...
import com.tts.myAwesomeDB.domain.Customer;
import com.tts.myAwesomeDB.repository.CustomerRepository;

@SpringBootApplication
public class MyAwesomeDbApplication {
	private static final Logger log = LoggerFactory.getLogger(MyAwesomeDbApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(MyAwesomeDbApplication.class, args);
	}
	@Bean
